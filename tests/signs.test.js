...
const { createSigns, SIGN_LABELS, SIGN_COLOURS, labelPixels, labelMetres } = await sourceModule('../src/signs.js');
...
test('every sign in the world carries a known label, stands on solid posts, and signs the roads it serves', async () => {
  ...
  for (const label of ['The Avrel Clearing', 'The Caloss Bridge', 'The Legion Camp', 'The Elodi Frontier', 'Elod'])
