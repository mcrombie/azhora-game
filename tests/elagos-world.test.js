...
test('the Ela-south leaves Lake Ela, runs through Ambron and only ever falls', () => {
  ...
  // The reach leaves the Lake Lands rather than stopping in the middle of them.
  // This used to be put as "runs off the west edge of the world", which was true
  // while Elagos was the westernmost built region; Vastos, Meneth, Caricas and
  // Nesdor now lie west of it, and Nesdor's drainage takes this water on.
