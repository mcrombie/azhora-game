...
test('twenty skills, twenty marks, drawn the way the satchel draws its items', () => {
  assert.equal(SKILL_IDS.length, 20, 'thirteen about the world, and the seven about fighting');
