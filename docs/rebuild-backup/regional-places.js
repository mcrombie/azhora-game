...
export const REGIONAL_NPC_POSITIONS = Object.freeze({
  'commons-miller': point(-29, -273), 'reed-worker': point(-25, -448), 'shelter-keeper': point(-23, -573),
});
export const REGIONAL_ACTIVITY_SITES = Object.freeze({
  'mill-hoist': Object.freeze({ id: 'mill-hoist', name: 'The grain hoist', x: -31, z: -280, region: 2 }),
  'net-float-west': Object.freeze({ id: 'net-float-west', name: 'First float line', x: -30, z: -449, region: 3 }),
  'net-float-east': Object.freeze({ id: 'net-float-east', name: 'Second float line', x: -35, z: -449, region: 3 }),
  'shelter-ledger': Object.freeze({ id: 'shelter-ledger', name: 'The shelter ledger', x: -32, z: -576, region: 4 }),
});
export const REGIONAL_PLACES = Object.freeze([
  Object.freeze({ id: 'mill-commons', name: 'The Mill Commons', x: -29, z: -273, radius: 10, region: 2,
    center: point(-35, -277), description: 'Grain sacks, a worn tally board, and a flour-dusted bench gather beneath the turning mill sails.' }),
  Object.freeze({ id: 'landing-workshop', name: 'The Landing Workshop', x: -25, z: -448, radius: 11, region: 3,
    center: point(-32, -452), description: 'A little boat rests on wooden stocks. Cork floats and drying nets hang above baskets of cut reeds.' }),
  Object.freeze({ id: 'waystation-shelter', name: 'The Waystation Shelter', x: -27, z: -577, radius: 10, region: 4,
    center: point(-32, -579), description: 'Patched canvas gives the roofless stones a purpose again: dry bedrolls, drinking water, and a book of travelers’ accounts.' }),
]);
export const REGIONAL_PATHS = Object.freeze([
  Object.freeze([point(-18, -276), point(-22, -273), point(-29, -273), point(-31, -277), point(-31, -280)]),
  Object.freeze([point(-4, -450), point(-10, -445), point(-19, -445), point(-25, -448), point(-30, -449), point(-35, -449)]),
  Object.freeze([point(-19, -576.5), point(-23, -573), point(-27, -574), point(-32, -576)]),
]);
// The original waystation spur was authored after its rock scatter. Reserve
// that existing approach too, without drawing a second road over its surface.
const clearancePaths = [...REGIONAL_PATHS, [point(1, -575), point(-12, -576), point(-19, -576.5)]];
...
export function regionalFeatureClear(x, z, margin = 0) {
  ...
  if (z > -263 + extra || z < -590 - extra || x > 1 + extra || x < -47 - extra) return false;
