...
- Luscia: Chip at the Caloss bridge; Sava's shrine and three waymarkers on the road south-west of the bridge; Iven's relay near the Lauvel field; the battlefield (broken carts, banners, a burial line, a Legion picket); a burned hamlet; wolves as scenery only.
