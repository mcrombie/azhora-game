...
export function createDeveloperMode({renderer,normalScene,world,player,onExit=()=>{}}) {
  ...
  function visit(destination){
    ...
    if(destination.scene==='playable-world'){
      const points={drent:{x:-15,z:29},luscia:{x:-386,z:183},moros:{x:-500,z:312},suval:{x:-56,z:636},'west-suval':{x:-530,z:875},pueth:{x:-110,z:-170},peblos:{x:334,z:428},'west-izol':{x:56,z:1725},elagos:{x:-1221,z:386}};
