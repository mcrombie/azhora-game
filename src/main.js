...
function init() {
  ...
  const archaeology=createArchaeology({skills}),wine=createWine({skills}),cooking=createCooking({skills}),digs=createRenaDigs(scene,world);let currentDig=null,currentVine=null;
