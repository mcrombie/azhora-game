 ...
 * the Legion's garrison of its outpost on the Moros (and the Coalition's, if it
...
export const TOWN_LIFE_NPCS = Object.freeze([
  ...
  person('life-avrel-farmer', 'Hild', 'Avrel farmer', 'commons-miller', PLACE_STANDS['life-avrel-farmer'], PLACE_STANDS['life-avrel-farmer'].yaw, [
    'The Legion buys our grain at its own price and calls it a kindness. Corvan is fair enough, for a quartermaster. The price is not his.',
  ...
  person('life-town-smith', 'Rook', 'Lumber Town smith', 'forest-woodcutter', PLACE_STANDS['life-town-smith'], PLACE_STANDS['life-town-smith'].yaw, [
    'Horseshoes, hinges, saw teeth and pots. I shoe the Legion’s horses too, and guess which of them pays on the day.',
    'Swords? Not here. There is a bench for that sort of thing at the Legion’s places, and they are welcome to it.',
  ], { color: 0x5f4a3a }),
  ...
  person('life-lauvel-healer', 'Maud', 'Healer at the field hospital', 'shelter-keeper', PLACE_STANDS['life-lauvel-healer'], PLACE_STANDS['life-lauvel-healer'].yaw, [
    'Rebel, legionary, farmer: I stitch whoever is still breathing. There are fewer of them every day.',
    'The cairn is for the ones nobody came to name. Add a stone if you pass it. Everyone does.',
  ], { color: 0x8a8272 }),

  // --- The Legion's outpost. The Legion speaks in orders.
  ...
  person('life-outpost-cook', 'Cook Albus', 'Legion cook', 'commons-miller', campPoint(-20.2, 14.8), 1.9, [
  ...
  person('life-outpost-drill', 'Optio Sextus Rufio', 'Optio of the camp guard', 'legion-soldier', campPoint(-1.2, -16.5), faceToward(campPoint(-1.2, -16.5), gateRoadPoint(9)), [
    'Hired swords muster on the parade ground, in a line I can count.',
    'When the Legate comes out, you stand still and you keep your mouth shut. Both, not one.',
  ], { ...EMPIRE, color: RED }),
  person('life-moros-picket-a', 'Legionary Nerva', 'Legion picket', 'legion-soldier', picketSpot(-2.5, 2.6), picket.yaw + Math.PI, [
    'Picket post. The camp is west along the road. Keep to it.',
    'We watch the road for the muster and for rebels. So far, sheep.',
  ], { ...EMPIRE, color: RED }),
  person('life-moros-picket-b', 'Legionary Stavro', 'Legion picket', 'legion-soldier', picketSpot(3.2, 2.2), picket.yaw, [
    'Stay off the fold wall. The shepherd sells to the Legion, and the Legion wants him selling.',
  ...
  person('life-outpost-coalition-gate-north', 'Coalition spearman', 'Valley company, at the main gate', 'suvali-guard', gateRoadPoint(26, -3.8), faceToward(centre, gateRoadPoint(40)), [
    'The outpost belongs to the Republic. Walk in if you have business; the Legion does not.',
  ...
  person('life-outpost-coalition-gate-south', 'Coalition spearman', 'Valley company, at the main gate', 'suvali-guard', gateRoadPoint(26, 3.8), faceToward(centre, gateRoadPoint(40)), [
    'We keep the gate the Legion kept. Same posts, better company.',
  ...
  person('life-outpost-coalition-rear', 'Coalition spearman', 'Valley company, at the rear gate', 'suvali-guard', campPoint(-50, 12), -Math.PI / 2, [
    ...
    'The horse line is thin. The Legion rode out with most of it.',
  ], { ...COALITION, color: COALITION_SLATE }),
  ...
  person('life-elodi-captain', 'Captain Aveth Orun', 'Captain of the Elodi frontier', 'elodi-guard', frontierPoint(-9.5, -3.4), toFrontier + Math.PI, [
    'Stop there. This border is closed by order of Elod. Nobody crosses: not you, not the Legion, not the Republic.',
