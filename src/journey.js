...
export function createJourney({ inventory, weapons, onEvent = () => {} } = {}) {
  ...
  function view() {
    ...
    const views = {
      ...
      complete: [4, 10, 3, 'Service, and its cost', 'Iven has copied Mara’s warning and recorded the people’s account, and the Legion has paid you in silver. Most people here wanted the republic it calls rebellion. Between a failing empire and goblin raids from the north, who will your service protect? He has another errand for you: the field at the Lauvel, up the road from this square.', []],
    };
