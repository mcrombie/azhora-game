...
export const BUILD_STATUS = Object.freeze({
  Drent: status('built', 'Tidehaven and its landing, the Greenway woods and their small places, Willowmere, the Avrel clearings, the road to the Caloss, the road north to the Tessen, the old Rena road with the ruins of Rena and Applegarth on it, deer, birds, insects and forage, the birding skill and Lakota’s garden.',
  ...
  // Terrain and wildlife only, on purpose: the four western regions were built as
  // country, and everything in them that belongs to somebody was left for later.
  Vastos: status('early', 'The cold tableland itself: flat upland grass above both its approaches, the Vastos River braiding across the south, the snowmelt beck off the Amod margin, five watering pans on the open range, sulfur ground with three vents on the western fall, two small lake basins on the eastern one, and longhorn cattle, hares and a hawk over the grass.',
    'Everybody. No winter quarters, no river crossings, no vel-vastos routes, no herders with the herds, and no way in from Elagos or Amod but open country.'),
