...
export const LIZ_GARDEN = Object.freeze({ ...point(-49,-187), width: 6, depth: 7,
  entry: point(-46,-187), beds: Object.freeze([point(-49,-189),point(-49,-185)]) });
export const LIZ_HOME_PATHS = Object.freeze([
  Object.freeze([point(-12,-188),point(-16,-178),point(-24,-173),point(-36,-171)]),
  Object.freeze([point(-24,-173),LIZ_COTTAGE.porch]),
]);
/**
