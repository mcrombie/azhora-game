...
export const journeySites = Object.freeze({
  ...
  'bridge-debris-1': Object.freeze({ id: 'bridge-debris-1', x: -322, z: 90, name: 'Dry driftwood', type: 'sticks', quantity: 2, region: 3 }),
  'bridge-debris-2': Object.freeze({ id: 'bridge-debris-2', x: -372, z: 92, name: 'Fallen branches', type: 'sticks', quantity: 2, region: 3 }),
