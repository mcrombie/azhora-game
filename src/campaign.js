...
export const CHAPTERS = Object.freeze({
  ...
  'moros-fallback': chapter('moros-fallback', 'Moros Plain', 'The line at the Moros',
    'The Legion lost the field and pulled back across the plain. The Coalition holds the border outpost now. Report to Ambron with the news; the war goes on.',
    { side: 'empire', control: { 'Moros Plain': 'coalition' }, next: 'report-ambron' }),
  ...
  'moros-outpost': chapter('moros-outpost', 'Moros Plain', 'The outpost on the plain',
    'The Legion broke. The Coalition takes the imperial outpost on the Moros, and Solis is safe behind you. West Suval and the plain belong to the Republic for now.',
  ...
  'solis-fallback': chapter('solis-fallback', 'West Suval', 'Back to Solis',
    ...
    { side: 'coalition', control: { 'Moros Plain': 'empire' }, next: 'sail-west-izol' }),
