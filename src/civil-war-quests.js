...
export const CIVIL_WAR_REGIONS = Object.freeze([
  entry('civil-war-vastos', 'Vastos', 'The Common Water',
    ...
    { status: 'paused', reward: Object.freeze({ item: 'salt-beef', count: 2 }) }),
  ...
  entry('civil-war-drent', 'Drent', 'Civil War in Drent',
    'After the Greenway ambush, Officer Glun wants the deserted camp searched. Any papers found there must be returned unread.',
    'Read the recovered evidence, entrust it to Killian in Tidehaven, learn Stealth and bring him supplies taken from the guarded barracks.',
    'Return the evidence to Glun, confront Killian alongside the officer, and report after defeating him to gain the Empire\'s favor.',
    'Reserved for a later pass: no mediation route is offered by this two-branch prototype, and neither faction handoff pretends to be a neutral outcome.',
    { status: 'playable', prototype: true }),
