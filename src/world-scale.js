...
export const CLUSTERS = Object.freeze([
  ...
  cluster('lauvel-relay', [-401, 196], 12, { note: 'The army’s old relay hut off the road above Nothom.' }),
  ...
  cluster('lumber-town', [-408, 228], 34, { note: 'Nothom’s square, its houses, the timber yard and the garrison.' }),
