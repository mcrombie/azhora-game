...
export function journeyConversation(npc,context) {
  ...
  if(npc.id==='ridge-keeper') {
    ...
    if(!state.ridgeAccepted)return tell([
      ...
      'Then carry Mara’s original letter on to Iven. He keeps the Legion’s relay post on the square at Lumber Town, down the road past the field at the Lauvel. Tell him what you have heard here; he copies reports for the army, and let this one include the people’s account.'
  ...
  if(npc.id==='relay-clerk') {
    if(journey.view().complete)return tell(['I have recorded both the goblin danger and what the people told you. Your Ambroni service continues; this report does not settle the war or release your contract. Keep Mara’s original. Stay in the square a moment: the next orders out of the Moros concern the field at the Lauvel, and they concern you.'],[]);
