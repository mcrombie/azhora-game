...
export const questSteps = [
  ...
  {title:'A little preparation', detail:'Find the straw practice post at the village crossroads.', lesson:'Learn at your own pace', hint:'Left-click or R to swing. Hold a direction and press Ctrl to dodge. Land two hits on the post and try one dodge.'},
