...
export const SUBREGIONS = Object.freeze([
  ...
  area('neth-ford', 'The Neth Ford', 'Nethereum', -2294, 592, 85, 'Gravel, shin-deep, below where the river comes off the desert edge. The only dry-shod way south out of this country, and the only place on the Neth that is one: everything below it runs deep to the Lizeem and nobody has bridged any of it.'),
