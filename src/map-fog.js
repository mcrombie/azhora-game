...
export const SUBREGIONS = Object.freeze([
  ...
  area('avrel', 'The Avrel Clearing', 'Drent', -421, 40, 75, 'Farm clearings in Drent’s forested upland: the mill commons, the army’s post and the road on to the Caloss.'),
